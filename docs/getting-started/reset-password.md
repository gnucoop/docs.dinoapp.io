...
description: How to set a new password after requesting a reset link from the Login page.
---
...
!!! warning
    The link you used is no longer valid. Reset links expire after a short time for security reasons. Go back to the [Login page](login.md), click **"Forgot your password?"** again, and request a new link.

### "Incorrect password"

!!! warning
    The password could not be saved. Make sure both fields contain exactly the same password and that it is at least 9 characters long, then try again. If the problem persists, request a new reset link from the Login page.
